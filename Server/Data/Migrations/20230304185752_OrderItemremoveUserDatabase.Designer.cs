...
namespace PawsomeProject.Server.Data.Migrations
{
    ...
    [Migration("20230304185752_OrderItemremoveUserDatabase")]
    partial class OrderItemremoveUserDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawsomeProject.Server.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawsomeProject.Server.Models.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PawsomeProject.Shared.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PawsomeProject.Server.Models.CartItem", b =>
                {
                    b.HasOne("PawsomeProject.Server.Models.Cart", "Cart")
                        .WithMany()
